 ...
 */
extern const char *poldiff_class_get_name(poldiff_t *diff, poldiff_class_t *cls);

/**
 *  Get the form of difference from a class diff.
 *  @param diff The policy difference structure associated with the class diff.
 *  @param cls The class from which to get the difference form.
 *  @return the form of difference (one of POLDIFF_FORM_*)or POLDIFF_FORM_NONE
 *  on error. If the call fails, errno will be set.
 */
extern poldiff_form_e poldiff_class_get_form(poldiff_t *diff, poldiff_class_t *cls);
 ...
 */
extern apol_vector_t *poldiff_class_get_added_perms(poldiff_t *diff, poldiff_class_t *cls);
...
/**
 *  Get the number of added classes from a policy difference structure.
...
/**
 *  Get the number of removed classes from a policy difference structure.
 *  @param diff The policy difference structure from which to get the
...
/**
 *  Get the number of modified classes from a policy difference structure.
 *  @param diff The policy difference structure from which to get the
 *  number ov modified classes.
 ...
 *  @return a vector of elements of type class_t, or NULL on error.
