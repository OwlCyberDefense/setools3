...
#define CONF_ERR_OPEN_POLICY	"Error accessing the policy.conf file. Check seuser.conf file.\n"
#define CONF_ERR_OPEN_DIR	"You need to define the policy directory parameter in your seuser.conf file.\n"
#define CONF_ERR_ACCESS_DIR	"Error accessing the policy directory. Check seuser.conf file.\n"
