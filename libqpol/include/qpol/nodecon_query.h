 ...
 */
extern int qpol_policy_get_nodecon_by_node(sepol_handle_t *handle, qpol_policy_t *policy, uint32_t addr[4], uint32_t mask[4], unsigned char protocol, qpol_nodecon_t **ocon);
 ...
 */
extern int qpol_policy_get_nodecon_iter(sepol_handle_t *handle, qpol_policy_t *policy, qpol_iterator_t **iter);
 ...
 */
extern int qpol_nodecon_get_context(sepol_handle_t *handle, qpol_policy_t *policy, qpol_nodecon_t *ocon, qpol_context_t **context);
