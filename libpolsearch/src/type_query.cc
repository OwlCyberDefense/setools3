...
polsearch_type_query::polsearch_type_query(polsearch_match_e m) throw(std::invalid_argument):polsearch_query(m)
{
	//nothing more to do
}
...
polsearch_element_e polsearch_type_query::elementType() const
{
