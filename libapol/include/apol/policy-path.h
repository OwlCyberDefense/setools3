...
#include "vector.h"
	...
	/**
	 * Type of policy this path represents - either a single path, for
	 * a monolithic policy, or a path + multiple modules for modular
	 * policy.
	 */
	...
	/**
	 * Create a policy path from scratch.  The resulting object
	 * represents the file or files needed to load a policy.
	 *
	 * @param path_type Type of policy to represent.
	 * @param path Primary path name.  For modular policies this
	 * is the base policy's path.
	 * @param modules Vector of strings representing modules'
	 * paths.  The vector can be NULL to mean no modules.  This
	 * parameter is ignored if path_type is not
	 * APOL_POLICY_PATH_TYPE_MODULAR.  The function will duplicate
	 * the vector and its contents.
	 *
	...
	/**
	 * Create a policy path, initialized by a special path format
	 * string.  Call apol_policy_path_to_string() to create this
	 * string.
	 *
	 * @param path_string String containing initialization data
	 * for the object.
	 *
	 * @return An apol_policy_path object, or NULL upon error.
	 */
	 ...
	 *
	 * @param path Policy path to destroy.  The pointer will be
	 * set to NULL afterwards.  (If pointer is already NULL then
	 * do nothing.)
	 */
	...
	/**
	 * Get the primary path name from a path object.  For
	 * monolithic policies this is the path to the policy.  For
	 * modular policies this is the base policy path.
	 *
	 * @param path Policy path object to query.
	 *
	...
	/**
	 * Get the list of modules from a path object.  This will be a
	 * vector of strings.  It is an error to call this function
	 * for non-modular policies.
	 *
	 * @param path Policy path object to query.
	 *
	 * @return Vector of module paths, or NULL upon error.  Do not
	 * modify this vector or its contents.  Note that the vector
	 * could be empty.
	 */
	 ...
	 * The resulting string is suitable as input to
	 * apol_policy_path_create_from_string().
	 *
	 * @param path Policy path object to encode.
	 *
	 * @return Formatted string for the path object, or NULL upon
	 * error.  The caller is responsible for calling free() upon
	 * the returned value.
	 */
