 ...
 * @param v Reference to a vector of sepol_isid_t. The vector will
 ...
 */
extern int apol_get_isid_by_query(apol_policy_t *p,
				  apol_isid_query_t *i,
				  apol_vector_t **v);
 ...
 */
extern int apol_isid_query_set_name(apol_policy_t *p,
				    apol_isid_query_t *i,
				    const char *name);
