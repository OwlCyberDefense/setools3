 ...
 */
	typedef enum sefs_fclist_type
	{
		...
		SEFS_FCLIST_TYPE_FCFILE,	/*!< get_data returns sefs_fcfile_t, a representation of a collection of file context files */
		SEFS_FCLIST_TYPE_DB    /*!< get_data returns sefs_db_t, a representation of a sqlite3 database of file system contexts */
	} sefs_fclist_type_e;

/**
 * Deallocate all memory associated with the referenced fclist object, and then
