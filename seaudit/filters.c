...
typedef struct role_filter {
	...
	int field;       /* may be FILTERS_SRC, or FILTERS_TGT */ 
} role_filter_t;
...
static bool_t msg_filter_action(msg_t *msg, void *data, bool_t *err)
{
...
static bool_t ssid_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
...
static bool_t tsid_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
...
static bool_t comm_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
	...
	*err = FALSE;
	if (!filter->comm || !msg->msg_data.avc_msg->comm)
		return FALSE;
	return strcmp(filter->comm, msg->msg_data.avc_msg->comm) == 0 ? TRUE : FALSE; 
}
static bool_t netif_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
...
static bool_t key_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
...
static bool_t capability_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
...
static bool_t port_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
...
static bool_t lport_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
...
static bool_t fport_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
...
static bool_t dest_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
...
static bool_t source_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
...
static bool_t laddr_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
	...
	*err = FALSE;
	if (!filter->laddr || !msg->msg_data.avc_msg->laddr)
		return FALSE;
	return strcmp(filter->laddr, msg->msg_data.avc_msg->laddr) == 0 ? TRUE : FALSE;
}
static bool_t faddr_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
	...
	*err = FALSE;
	if (!filter->faddr || !msg->msg_data.avc_msg->faddr)
		return FALSE;
	return strcmp(filter->faddr, msg->msg_data.avc_msg->faddr) == 0 ? TRUE : FALSE;
}
static bool_t daddr_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
	...
	*err = FALSE;
	if (!filter->daddr || !msg->msg_data.avc_msg->daddr)
		return FALSE;
	return strcmp(filter->daddr, msg->msg_data.avc_msg->daddr) == 0 ? TRUE : FALSE;
}
static bool_t saddr_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
	...
	*err = FALSE;
	if (!filter->saddr || !msg->msg_data.avc_msg->saddr)
		return FALSE;
	return strcmp(filter->saddr, msg->msg_data.avc_msg->saddr) == 0 ? TRUE : FALSE;
}



static bool_t date_filter_action(msg_t *msg, void *date, bool_t *err)
...
static bool_t exe_filter_action(msg_t *msg, void *data, bool_t *err)  
{ 
	filter_t *d = (filter_t*)data;
	...
	*err = FALSE;
	if (!filter->exe || !msg->msg_data.avc_msg->exe)
		return FALSE;
	return strcmp(filter->exe, msg->msg_data.avc_msg->exe) == 0 ? TRUE : FALSE; 
} 

/*
 * filter based on object path */
static bool_t path_filter_action(msg_t *msg, void *data, bool_t *err)  
{ 
	filter_t *d = (filter_t*)data;
	...
	*err = FALSE;
	if (!filter->path || !msg->msg_data.avc_msg->path)
		return FALSE;
	return strcmp(filter->path, msg->msg_data.avc_msg->path) == 0 ? TRUE : FALSE;
} 

/*
 * filter based on device of object */
static bool_t dev_filter_action(msg_t *msg, void *data, bool_t *err) 
{ 
	filter_t *d = (filter_t*)data;
...
static bool_t src_user_filter_action(msg_t *msg, void *data, bool_t *err)
{
	int i;
	filter_t *d = (filter_t*)data; 
...
static bool_t tgt_user_filter_action(msg_t *msg, void *data, bool_t *err)
{
	int i;
	filter_t *d = (filter_t*)data; 
	user_filter_t *filter = (user_filter_t*)(d->data);
...
static bool_t src_role_filter_action(msg_t *msg, void *data, bool_t *err)
{
	int i; 
	filter_t *d = (filter_t*)data; 
...
static bool_t tgt_role_filter_action(msg_t *msg, void *data, bool_t *err)
{
	int i; 
	filter_t *d = (filter_t*)data; 
	role_filter_t *filter = (role_filter_t*)(d->data);
...
static bool_t src_type_filter_action(msg_t *msg, void *data, bool_t *err)
{
	int i; 
	filter_t *d = (filter_t*)data;
...
/*
 * filter based on a source type */
static bool_t tgt_type_filter_action(msg_t *msg, void *data, bool_t *err)
{
	int i; 
	filter_t *d = (filter_t*)data;
	type_filter_t *filter = (type_filter_t*)(d->data);
...
static bool_t class_filter_action(msg_t *msg, void *data, bool_t *err) 
{ 
	int i; 
        filter_t *d = (filter_t*)data; 
...
static bool_t perms_filter_action(msg_t *msg, void *data, bool_t *err)
...
static bool_t inode_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
...
static bool_t pid_filter_action(msg_t *msg, void *data, bool_t *err)
{
	filter_t *d = (filter_t*)data;
