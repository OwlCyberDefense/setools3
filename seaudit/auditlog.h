...
#define AVC_NUM_FIELDS		31

#define LOAD_POLICY_USERS_FIELD   32
#define LOAD_POLICY_ROLES_FIELD   33
#define LOAD_POLICY_TYPES_FIELD   34
#define LOAD_POLICY_CLASSES_FIELD 35
#define LOAD_POLICY_RULES_FIELD   36
#define LOAD_POLICY_BINARY_FIELD  37
#define LOAD_POLICY_NUM_FIELDS    6

#define DATE_FIELD		38
#define AVC_MISC_FIELD          39
...
typedef struct audit_log {
	...
	msg_t **fltr_msgs;      /* filtered and sorted messages */
	int fltr_msgs_types; /* the message types stored in the */
